                                ...
                                <form action="updateTea" method="post">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>ID</label>
                                                <input type="text" name="id" class="form-control"  value="<s:property value="#session.teacher.Tid"/>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>姓名</label>
                                                <input type="text" class="form-control" placeholder="姓名" name="name" value="<s:property value="#session.teacher.Tname"/>">
                                            </div>
