    ...
    <!--   you can change the color of the sidebar using: data-color="blue | azure | green | orange | red | purple" -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="TeaSelectedAction?tid=<s:property value="#session.teacher.tid"/>">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                           <a href="">
                               <s:property value="#session.teacher.Tname"/>教师， 欢迎登陆选课系统
                            </a>
                        </li>
                        <li>
                            <a href="TeaLogout">
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <s:iterator value="courses" var="course">
                                    	 <tr>
                                        	...
                                        	<td><s:property value="#request.sid"/></td>
                                        </tr>
                                    </s:iterator>
                                    </tbody>
                                </table>
...
<div>
							...
							<ul class="pagination">
								<li><a href="TeaCourseAction" aria-label="Previous">
										<span aria-hidden="true">&laquo;</span>
								</a></li>
								<c:forEach begin="1" end="${sessionScope.result.totalPage}"
									step="1" var="pageIndex">
									<li><a href="TeaCourseAction?pageNum=${pageIndex}">${pageIndex}
									</a></li>
								</c:forEach>
								<li><a
									href="TeaCourseAction?pageNum=<s:property value="#session.result.totalPage"/>"
