    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="header">
									<h4 class="title">課程列表</h4>
									<p class="category">可以对课程信息进行编辑或删除操作</p>
										...
										<tbody>
											<s:iterator value="courses" var="course">
												<tr>
													...
													<td><a
														href="DelCourseAction?Cid=<s:property value="#course.Cid"/>">刪除</a></td>
												</tr>
											</s:iterator>
										</tbody>
						...
						<div>
							...
							<ul class="pagination">
								<li><a href="FindCourseAction" aria-label="Previous">
										<span aria-hidden="true">&laquo;</span>
								</a></li>
								<c:forEach begin="1" end="${sessionScope.result.totalPage}"
									step="1" var="pageIndex">
									<li><a href="FindCourseAction?pageNum=${pageIndex}">${pageIndex}
									</a></li>
								</c:forEach>
								<li><a
									href="FindCourseAction?pageNum=<s:property value="#session.result.totalPage"/>"
			...
			<div style='position:absolute z-index:999; top:0;'>
				<button type="button" class="btn btn-default btn-lg btn-block"  onclick="window.location.href='CreateCourse'">添加课程</button>
			</div>
        <footer class="footer">
            <div class="container-fluid">
